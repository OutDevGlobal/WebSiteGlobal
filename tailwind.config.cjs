  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        // Development Areas
        'technological-dev':
          "url('/img/development-areas/technological_development.png')",
        'art-and-entretainment':
          "url('/img/development-areas/art_and_entretainment.png')",
        ...
        // AR / VR / MR Service
        'agile-education':
          "url('/img/ar-vr-mr-development/agile_education.png')",
        'art-preservation':
          "url('/img/ar-vr-mr-development/art_preservation.png')",
        'body-analysis': "url('/img/ar-vr-mr-development/body_analysis.png')",
        'medical-checkup':
          "url('/img/ar-vr-mr-development/medical_checkup.png')",

        // Inmersive Web Service
        'data-visualization':
          "url('/img/inmersive-web-development/data_visualization.png')",
        ...
        // Web 2 Service
        'content-managment':
          "url('/img/web-2-development/content_managment_system.png')",
        'custom-software':
          "url('/img/web-2-development/custom_software_development.png')",
        ...
        'decentralized-solutions':
          "url('/img/web-3-development/decentralized_solutions.png')",
        ...
        navIconBorderEmpty: "url('/svg/brand/navigationIconBorderEmpty.svg')",
      },
      animation: {
