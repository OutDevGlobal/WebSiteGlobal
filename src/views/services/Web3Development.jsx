          ...
          <div className="py-40 pointer-events-none">
            <Animator animation={batch(Fade(), MoveIn(200, 0), Sticky())}>
              <p className="text-lg lg:text-2xl 2xl:text-3xl mt-10 md:w-full">
                The answer to the dilemma of the Web being monopolized by big
                corporations is that web 3.0 gives the power to individuals in
                the form of ownership. To achieve this, Web 3.0 uses
                blockchains, cryptocurrencies and NFTs, being this the
                “read-write-own” web.
              </p>
            </Animator>
          </div>
                ...
                <div className="col-start-2 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      A non-fungible token (NFT) is an approach to tracking as
                      well as adding value to a unique piece of digital media.
                      In essence, it is a digital version of a concrete
                      collector’s item that is stored in a digital wallet or
                      blockchain, offering proof of unique ownership and
                      authenticity.
                    </p>
                  </Animator>
                </div>
            ...
            <div className="self-center">
              <div className="md:absolute bottom-5 grid grid-cols-1 md:grid-cols-6 z-10">
                <div className="col-start-3 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      A token is a programmable digital unit of value that is
                      recorded on a digital ledger, in this case crypto tokens
                      are digital units used for transaction amoing
                      decentrilized environments. These tokens are designed to
                      be used for a particular purpose, usually within the
            ...
            <div className="self-center">
              <div className="md:absolute bottom-5 grid grid-cols-1 md:grid-cols-6 z-10">
                <div className="col-start-2 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      Are applications or programs that exist and run on a
                      blockchain network instead of a single computer. This kind
                      of apps are outside the purview and control of a single
                      authority. One of their benefits include the safeguarding
                      of user privacy, the lack of censorship, and the
              ...
              <div className="grid grid-cols-1 md:grid-cols-6 z-0">
                ...
                >
                  <div
                    className="
                      bg-left-image bg-fixed bg-decentralized-solutions bg-no-repeat
                      w-full h-image-mobile md:w-image-wide md:h-image-wide top-0
                    "
                  />
                </div>
              </div>
