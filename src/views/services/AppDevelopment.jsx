              ...
              <div className="pointer-events-none h-full">
                ...
                <Animator animation={batch(Fade(), MoveOut(-200, 0))}>
                  <p className="text-4xl md:text-6xl 2xl:text-8xl font-montserrat font-extrabold">
                    We code beautiful and interactive Cross-platform mobile
                    Apps.
                  </p>
                </Animator>
              </div>
          ...
          <div className="py-40 pointer-events-none">
            <Animator animation={batch(Fade(), MoveIn(200, 0), Sticky())}>
              <p className="text-lg lg:text-2xl 2xl:text-3xl mt-10 md:w-full">
                Mobile apps have their roots in more traditional software
                development. However, one critical difference is that mobile
                ...
                <div className="col-start-2 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      Android is an open source operating system with the
                      highest community and developers reach which is the
                      highest reason for it having the increased marketing and
            ...
            <div className="self-center">
              <div className="md:absolute bottom-5 grid grid-cols-1 md:grid-cols-6 z-10">
                <div className="col-start-3 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      IOS development is the process of creating applications
                      for Apple’s mobile operating system—the operating system
                      used by the iPhone and iPod Touch. In this most
                      fundamental sense, it has a lot in common with other types
                      of software or app development, but there are a few key
                      differences.
                    </p>
                  </Animator>
                </div>
            ...
            <div className="self-center">
              <div className="md:absolute bottom-5 grid grid-cols-1 md:grid-cols-6 z-10">
                <div className="col-start-2 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      The best way to develop all this apps is doing it just one
                      time, using a different programming software we can write
                      a unique code that would be use in both of the operating
                      system. In this sense, we can optimize the processes to
                      develop the apps, ensuring that those apps would run in
                      any device that uses any of the operating systems.
                    </p>
                  </Animator>
                </div>
              </div>
