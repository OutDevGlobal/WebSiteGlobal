          ...
          <div className="py-40 pointer-events-none">
            <Animator animation={batch(Fade(), MoveIn(200, 0), Sticky())}>
              <p className="text-lg lg:text-2xl 2xl:text-3xl mt-10 md:w-full">
                The incorporation of digital realities in the new developmets
                allow us to create unimaginable worlds that we can appreciate
                just by using or smartphones, forging worlds that are out of
                ...
                <div className="col-start-2 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      The beauty of art could be lost in a blink of an eye,
                      natural disasters, accidents and even time are some of the
                      enemies of this pieces, through the use of a nft we could
                      preserve the beauty of the piece and the unique value that
                      it has implicit, giving the owner the safety that there's
                      not another legit owner that could claims the property of
                      the NFT. Doing this we can keep these beauty for the
                      eternity.
                    </p>
                  </Animator>
                </div>
            ...
            <div className="self-center">
              <div className="md:absolute bottom-5 grid grid-cols-1 md:grid-cols-6 z-10">
                <div className="col-start-3 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      The use of data to improve the body health is a reality
                      through data science, using some standard metrics we could
                      know how good or bad we are according to that standars in
                      a faster and direct way.
                    </p>
                  </Animator>
                </div>
              </div>
            ...
            <div className="self-center">
              <div className="md:absolute bottom-5 grid grid-cols-1 md:grid-cols-6 z-10">
                <div className="col-start-2 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      The use of augmented and virtual reality for the analysis
                      of our bodies would be the key we needed to improve the
                      way we understand how our body works and to communicate
                      what diseases do to our bodies, making way much more easy
                      the understanding processes to the patient and trying to
                      arouse people’s interest in their health care
                    </p>
                  </Animator>
                </div>
              </div>
            ...
            <div className="self-center">
              <div className="md:absolute bottom-5 grid grid-cols-1 md:grid-cols-6 z-10">
                <div className="col-start-3 col-span-2">
                  ...
                  <Animator animation={batch(Fade(), MoveIn(200, 0))}>
                    <p className="font-sofia font-light font-md lg:text-xl xl:text-2xl">
                      Integrating technology to the traditional learning
                      processes would be the needed jump to make way faster the
                      way people learn and implement information in their daily
                      activities. Incorporate the use of augmented and virtual
                      reality to schools could give to students the confidence
                      to put in practice on a real environment what they have
                      learned on the safety of a classroom
                    </p>
                  </Animator>
                </div>
              </div>
